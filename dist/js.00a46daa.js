...
var carouselCaptionHRs = document.querySelectorAll(".carousel-caption");
var captionWidth = window.getComputedStyle(document.querySelector(".carousel-caption")).getPropertyValue("width");

var _iterator = _createForOfIteratorHelper(carouselCaptionHRs),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var carouselCaptionHR = _step.value;
